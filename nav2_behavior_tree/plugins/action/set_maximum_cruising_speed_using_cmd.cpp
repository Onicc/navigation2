...
#include "nav2_behavior_tree/plugins/action/set_maximum_cruising_speed_using_cmd.hpp"

namespace nav2_behavior_tree
{

SetMaximumCruisingSpeedUsingCmd::SetMaximumCruisingSpeedUsingCmd(
...
inline BT::NodeStatus SetMaximumCruisingSpeedUsingCmd::tick()
{
  ...
  msg.data = cmd_vel.linear.x;
  maximum_crusing_speed_pub_->publish(msg);

  return BT::NodeStatus::SUCCESS;
}

inline bool SetMaximumCruisingSpeedUsingCmd::getRobotPose(
...
double
SetMaximumCruisingSpeedUsingCmd::poseDistance(
...
BT_REGISTER_NODES(factory) {
  factory.registerNodeType<nav2_behavior_tree::SetMaximumCruisingSpeedUsingCmd>(
    "SetMaximumCruisingSpeedUsingCmd");
}
