...
#include "nav2_behavior_tree/plugins/action/toggle_forward_backward_mode.hpp"

namespace nav2_behavior_tree
{

ToggleForwardBackwardMode::ToggleForwardBackwardMode(
...
inline BT::NodeStatus ToggleForwardBackwardMode::tick()
{
...
{
  factory.registerNodeType<nav2_behavior_tree::ToggleForwardBackwardMode>("ToggleForwardBackwardMode");
}
