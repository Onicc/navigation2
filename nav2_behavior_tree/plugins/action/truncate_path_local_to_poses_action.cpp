...
#include "nav2_behavior_tree/plugins/action/truncate_path_local_to_poses_action.hpp"

namespace nav2_behavior_tree
{

TruncatePathLocalToPoses::TruncatePathLocalToPoses(
...
inline BT::NodeStatus TruncatePathLocalToPoses::tick()
{
...
inline bool TruncatePathLocalToPoses::getRobotPose(
...
double
TruncatePathLocalToPoses::poseDistance(
...
BT_REGISTER_NODES(factory) {
  factory.registerNodeType<nav2_behavior_tree::TruncatePathLocalToPoses>(
    "TruncatePathLocalToPoses");
}
