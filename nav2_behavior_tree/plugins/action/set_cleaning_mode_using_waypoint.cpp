...
#include "nav2_behavior_tree/plugins/action/set_cleaning_mode_using_waypoint.hpp"

namespace nav2_behavior_tree
{

SetCleaningModeUsingWaypoint::SetCleaningModeUsingWaypoint(
...
inline BT::NodeStatus SetCleaningModeUsingWaypoint::tick()
{
  ...
  cleaning_mode_msg.data = waypoint.option_cleaning_mode;
  cleaning_mode_pub_->publish(cleaning_mode_msg);

  return BT::NodeStatus::SUCCESS;
}

inline bool SetCleaningModeUsingWaypoint::getRobotPose(
...
double
SetCleaningModeUsingWaypoint::poseDistance(
...
BT_REGISTER_NODES(factory) {
  factory.registerNodeType<nav2_behavior_tree::SetCleaningModeUsingWaypoint>(
    "SetCleaningModeUsingWaypoint");
}
