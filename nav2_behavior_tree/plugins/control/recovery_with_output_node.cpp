...
#include <string>
#include "nav2_behavior_tree/plugins/control/recovery_with_output_node.hpp"

namespace nav2_behavior_tree
{

RecoveryWithOutputNode::RecoveryWithOutputNode(
...
BT::NodeStatus RecoveryWithOutputNode::tick()
{
  ...
  setOutput("retry_count", static_cast<int>(retry_count_));
...
void RecoveryWithOutputNode::halt()
{
  ControlNode::halt();
  retry_count_ = 0;
  current_child_idx_ = 0;
...
{
  factory.registerNodeType<nav2_behavior_tree::RecoveryWithOutputNode>("RecoveryWithOutputNode");
}
