...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__GENERATE_GOAL_FOR_FOLLOWING_CURBS_ACTION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__GENERATE_GOAL_FOR_FOLLOWING_CURBS_ACTION_HPP_
 ...
 */
class GenerateGoalForFollowingCurbs : public BT::ActionNodeBase
{
public:
  typedef std::vector<geometry_msgs::msg::PoseStamped> Goals;

  /**
   * @brief A nav2_behavior_tree::GenerateGoalForFollowingCurbs constructor
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::InputPort<double>("x", 4.0, "Distance in forward direction"),
      BT::InputPort<double>("y", -4.0, "Distance in backward direction"),
      BT::InputPort<double>(
      ...
      BT::InputPort<double>("off_path_tolerance", 0.2, "Transform lookup tolerance"),
      ...
      BT::OutputPort<geometry_msgs::msg::PoseStamped>("output_goal", "Goals with passed viapoints removed"),
    };
  }
...
#endif  // NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__GENERATE_GOAL_FOR_FOLLOWING_CURBS_ACTION_HPP_
