...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__SET_MAXIMUM_CRUISING_SPEED_USING_CMD_ACTION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__SET_MAXIMUM_CRUISING_SPEED_USING_CMD_ACTION_HPP_
 ...
 */
class SetMaximumCruisingSpeedUsingCmd : public BT::ActionNodeBase
{
public:
  typedef std::vector<geometry_msgs::msg::PoseStamped> Goals;

  /**
   * @brief A nav2_behavior_tree::SetMaximumCruisingSpeedUsingCmd constructor
