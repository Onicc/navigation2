 ...
 */
class SetCleaningModeUsingWaypoint : public BT::ActionNodeBase
{
public:
  typedef std::vector<geometry_msgs::msg::PoseStamped> Goals;

  /**
   * @brief A nav2_behavior_tree::SetCleaningModeUsingWaypoint constructor
...
private:
  ...
  rclcpp::Publisher<std_msgs::msg::Int32>::SharedPtr cleaning_mode_pub_;
};
