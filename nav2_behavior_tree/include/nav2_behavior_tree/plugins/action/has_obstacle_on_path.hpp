...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__HAS_OBSTACLE_ON_PATH_ACTION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__HAS_OBSTACLE_ON_PATH_ACTION_HPP_
 ...
 */
class HasObstacleOnPath : public BT::ActionNodeBase
{
public:
  typedef std::vector<geometry_msgs::msg::PoseStamped> Goals;

  /**
   * @brief A nav2_behavior_tree::HasObstacleOnPath constructor
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::InputPort<nav2_msgs::msg::Costmap>("costmap_msg", "Costmap message"),
      BT::InputPort<double>("goal_inflation_radius", 1.0, "Goal inflation radius"),
...
private:
  ...
  bool hasObstacleInInflationRadius(const geometry_msgs::msg::PoseStamped& goal, double inflation_radius);
...
#endif  // NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__HAS_OBSTACLE_ON_PATH_ACTION_HPP_
