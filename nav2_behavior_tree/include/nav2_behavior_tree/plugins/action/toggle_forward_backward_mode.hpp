...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__TOGGLE_FORWARD_BACKWARD_MODE_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__TOGGLE_FORWARD_BACKWARD_MODE_HPP_
...
class ToggleForwardBackwardMode : public BT::ActionNodeBase
{
public:
