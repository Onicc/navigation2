...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__FIND_NEAREST_POINT_INDEX_ACTION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__FIND_NEAREST_POINT_INDEX_ACTION_HPP_
 ...
 */
class FindClosestPointIndex : public BT::ActionNodeBase
{
public:
  typedef std::vector<geometry_msgs::msg::PoseStamped> Goals;

  /**
   * @brief A nav2_behavior_tree::FindClosestPointIndex constructor
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<int>("output_closest_index", "Outpuut closest waypoint index"),
