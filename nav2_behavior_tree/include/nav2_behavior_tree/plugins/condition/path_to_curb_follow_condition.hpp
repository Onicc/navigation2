...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__CONDITION__PATH_TO_CURB_FOLLOW_CONDITION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__CONDITION__PATH_TO_CURB_FOLLOW_CONDITION_HPP_
 ...
 */
class PathToCurbFollowCondition : public BT::ConditionNode
{
public:
  /**
   * @brief A constructor for nav2_behavior_tree::PathToCurbFollowCondition
   * @param condition_name Name for the XML tag for this node
   * @param conf BT node configuration
   */
  PathToCurbFollowCondition(
    const std::string & condition_name,
    const BT::NodeConfiguration & conf);

  PathToCurbFollowCondition() = delete;
