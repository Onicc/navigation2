...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_WITH_OUTPUT_NODE_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_WITH_OUTPUT_NODE_HPP_
...
{
/**
 * @brief The RecoveryWithOutputNode has only two children and returns SUCCESS if and only if the first child
 * returns SUCCESS.
 *
 ...
 *
 */
class RecoveryWithOutputNode : public BT::ControlNode
{
public:
  /**
   * @brief A constructor for nav2_behavior_tree::RecoveryWithOutputNode
  ...
  /**
   * @brief A destructor for nav2_behavior_tree::RecoveryWithOutputNode
   */
  ~RecoveryWithOutputNode() override = default;
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<int>("retry_count", "Retry count"),
    };
  }
